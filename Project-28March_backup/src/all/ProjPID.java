...
public class ProjPID extends Thread {
    ...
    */
     ...
     */
    static void Integration(String name, String algo, String trans, String key) throws IOException, InterruptedException, CryptoException, CantUnZipException, Exception {
